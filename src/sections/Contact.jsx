...
export default function Contact() {
  return (
    <section id="contact" className="py-28 px-6 bg-transparent relative border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        ...
        >
          {/* Main Card Shell */}
          <div className="premium-card bg-[#18191b]/40 border border-white/5 p-8 sm:p-12 md:p-16 rounded-[2rem] shadow-2xl relative overflow-hidden">
            ...
            <div className="absolute bottom-6 left-12 text-white/[0.02] animate-spin-slow pointer-events-none hidden md:block">
            ...
            <div className="absolute top-8 right-24 text-white/[0.02] animate-spin-slow pointer-events-none hidden md:block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-5 space-y-6 lg:pl-8 border-t lg:border-t-0 lg:border-l border-white/5 pt-8 lg:pt-0">
                
                {/* Phone */}
                <div className="flex items-center gap-4 group">
                  <div className="h-10 w-10 rounded-xl bg-white/[0.03] border border-white/5 flex items-center justify-center text-zinc-400 group-hover:text-white transition-colors duration-300">
                    <FiPhone className="h-4 w-4" />
                  </div>
                  <div>
                    <span className="text-[9px] font-bold text-zinc-500 block uppercase tracking-widest mb-0.5">
                      Phone Number
                    </span>
                    <a className="text-sm font-semibold text-white hover:text-zinc-300 transition-colors duration-300 hover-target" href={`tel:${personal.phone.replace(/[^+\d]/g, '')}`}>
                      {personal.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="h-10 w-10 rounded-xl bg-white/[0.03] border border-white/5 flex items-center justify-center text-zinc-400">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <a className="text-sm font-semibold text-white hover:text-zinc-300 transition-colors duration-300 hover-target" href={personal.github} target="_blank" rel="noopener noreferrer">
