...
export const projects = [
  ...
  },
  {
    ...
    desc: "Premium single-page agency website featuring section-based anchor navigation, custom canvas particles, custom box-shadow glows, and service inquiries.",
    tags: ["React.js", "Vite.js", "Tailwind CSS", "Framer Motion", "Web"],
    link: null,
    github: "https://github.com/Farhathullah-Najeeb",
    badge: "Featured",
  },
  {
    ...
    desc: "Smart billing and automated invoicing system with multi-client financial reporting, delivered for enterprise B2B clients.",
    tags: ["Flutter", "Stripe", "Razorpay", "REST API", "PDF"],
    link: null,
    github: "https://github.com/Farhathullah-Najeeb",
    badge: "Live",
  },
  {
    ...
    desc: "EdTech platform with live quizzes, course management, and real-time sessions.",
    tags: ["Flutter", "Firebase", "WebRTC", "EdTech"],
    link: null,
    github: "https://github.com/Farhathullah-Najeeb",
    badge: "Live",
  },
  {
    ...
    name: "E-Wallet",
    category: "Fintech · Mobile App",
    desc: "Banking-grade digital wallet with fund transfers, transaction history, and secure payment flows.",
  ...
  },
  {
    ...
    name: "HRM App",
    category: "Enterprise · Mobile App",
    desc: "Comprehensive Human Resource Management mobile application with employee profile tracking, attendance check-ins, and payroll monitoring.",
    tags: ["Flutter", "Provider", "BLoC", "REST API"],
    link: null,
    github: "https://github.com/Farhathullah-Najeeb",
    badge: "BUILDING",
    status: "in-progress"
  ...
  {
    id: "12",
    name: "Sana N Portfolio",
    category: "Marketing & Design · Web",
    desc: "Custom portfolio site for a content creator and social media marketing specialist, highlighting brand growth case studies, work samples, and academic history.",
